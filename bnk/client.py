...
class KnifeClient:
    ...
    def _request_control(self, method: str, session: Optional[str] = None) -> Dict[str, Any]:
    ...
    def request_interrupt(self, session: Optional[str] = None) -> Dict[str, Any]:
        return self._request_control("request_interrupt", session)
